      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.surfing,color: Colors.indigo,size: 45,),
              title: TextTop("Balis beach"),
              subtitle: Wrap(
                children: [Icon(Icons.star,color: Colors.yellow),Icon(Icons.star,color: Colors.yellow),Icon(Icons.star,color: Colors.yellow),Icon(Icons.star,color: Colors.yellow), Text("4.1"),],
              ),
            ),
            // Datos del hotel
            Row(
